...
class ASResource
{
    public:
        ...
        static const string AS_BEGIN, AS_GENERATE, AS_INTERFACE, AS_CASE, AS_CASEX, AS_CASEZ, AS_FUNCTION, AS_FORK, AS_TABLE, AS_TASK, AS_SPECIFY, AS_PRIMITIVE; // add verilog

        static const string AS_END, AS_ENDGENERATE, AS_ENDINTERFACE, AS_ENDCASE, AS_ENDFUNCTION, AS_JOIN, AS_ENDTASK, AS_ENDTABLE, AS_ENDSPECIFY, AS_ENDPRIMITIVE;
